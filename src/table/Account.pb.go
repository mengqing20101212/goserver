...
type RoleShow struct {
	...
	Lv              uint32 `protobuf:"varint,4,opt,name=lv,proto3" json:"lv,omitempty"`                                                    //等级
	LastLoginTimer  uint32 `protobuf:"varint,5,opt,name=last_login_timer,json=lastLoginTimer,proto3" json:"last_login_timer,omitempty"`    //上次登录时间
	LastLogoutTimer uint32 `protobuf:"varint,6,opt,name=last_logout_timer,json=lastLogoutTimer,proto3" json:"last_logout_timer,omitempty"` //上次登出时间
}
...
type Account struct {
	...
	AccountName string        `protobuf:"bytes,2,opt,name=account_name,json=accountName,proto3" json:"account_name,omitempty"`  //账号
	CreateTimer uint32        `protobuf:"varint,3,opt,name=create_timer,json=createTimer,proto3" json:"create_timer,omitempty"` //创建时间
	LoginTimer  uint32        `protobuf:"varint,4,opt,name=login_timer,json=loginTimer,proto3" json:"login_timer,omitempty"`    //登录时间
	LogoutTimer uint32        `protobuf:"varint,5,opt,name=logout_timer,json=logoutTimer,proto3" json:"logout_timer,omitempty"` //登出时间
	Phone       string        `protobuf:"bytes,6,opt,name=phone,proto3" json:"phone,omitempty"`                                 //len[1024]  手机号
	RoleList    *RoleShowList `protobuf:"bytes,7,opt,name=role_list,json=roleList,proto3" json:"role_list,omitempty"`           //角色列表
}
...
var file_table_Account_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x22, 0xc3, 0x01, 0x0a,
	0x08, 0x52, 0x6f, 0x6c, 0x65, 0x53, 0x68, 0x6f, 0x77, 0x12, 0x17, 0x0a, 0x07, 0x72, 0x6f, 0x6c,
	...
	,
	...
	,
...
var file_table_Account_proto_goTypes = []any{
	(*RoleShow)(nil),     // 0: table.RoleShow
	(*RoleShowList)(nil), // 1: table.RoleShowList
	(*Account)(nil),      // 2: table.Account
}
var file_table_Account_proto_depIdxs = []int32{
	0, // 0: table.RoleShowList.role:type_name -> table.RoleShow
	1, // 1: table.Account.role_list:type_name -> table.RoleShowList
